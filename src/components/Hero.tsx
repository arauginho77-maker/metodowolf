...
const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-orange-50 via-white to-orange-100">
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-accent/5" />
      
      <div className="container mx-auto px-4 relative z-10 py-32">
        <div className="max-w-4xl mx-auto text-center text-foreground">
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight text-primary">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-10 text-left max-w-3xl mx-auto">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start gap-3 bg-white/80 backdrop-blur-sm p-4 rounded-lg shadow-card border border-primary/10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button variant="outline" size="xl" onClick={scrollToCourses} className="bg-white/80 backdrop-blur-sm border-primary text-primary hover:bg-primary hover:text-primary-foreground">
              Ver cursos
            </Button>
          </div>
        </div>
